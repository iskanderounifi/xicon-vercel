...
const HeroSection = () => {
  return (
    <div className="font-montserrat w-full max-w-[1653px] h-[603px] relative mx-auto bg-white" id="contact">
      {/* Decorative Ellipses */}
      <div className="w-96 h-96 left-[1245px] top-[173px] absolute bg-amber-200 rounded-full" />
      <div className="w-56 h-56 left-0 top-[381px] absolute bg-rose-50 rounded-full" />
      <div className="w-32 h-32 left-[842px] top-0 absolute mix-blend-multiply bg-cyan-300 rounded-full" /> {/* Used mix-blend-multiply */}

      {/* Main Content Area */}
      <div className="max-w-xl left-[224px] top-[55px] absolute inline-flex flex-col justify-start items-start gap-20">
        {/* Hero Text */}
        <div className="self-stretch flex flex-col justify-start items-start gap-9">
          ...
          <div className="self-stretch h-16 text-justify text-2xl">
        ...
        <div className="inline-flex justify-start items-center gap-7">
          <button className="w-full max-w-xs h-16 px-6 py-5 bg-[#51B3D8] rounded-xl inline-flex justify-start items-center gap-3 text-white hover:opacity-90 transition-opacity">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_1_967_hero_cta1)">
                <path fillRule="evenodd" clipRule="evenodd" d="M13.232 1.36C13.864 0.601999 15.095 1.12 14.995 2.102L14.289 9H20C20.19 9.00007 20.3761 9.05428 20.5364 9.15627C20.6967 9.25826 20.8247 9.40382 20.9052 9.5759C20.9858 9.74798 21.0157 9.93946 20.9914 10.1279C20.9671 10.3164 20.8896 10.494 20.768 10.64L10.768 22.64C10.136 23.398 8.905 22.88 9.005 21.898L9.711 15H4C3.80999 14.9999 3.62392 14.9457 3.4636 14.8437C3.30328 14.7417 3.17534 14.5962 3.09476 14.4241C3.01417 14.252 2.98428 14.0605 3.00859 13.8721C3.0329 13.6836 3.11039 13.506 3.232 13.36L13.232 1.36Z" className="fill-current"/> {/* fill="var(--P2---C6, #F5FFFF)" */}
              </g>
      ...
      {/* Scroll Indicator */}
      <div className="w-10 left-[842px] top-[490px] absolute inline-flex flex-col justify-start items-center gap-1.5">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_1_980_hero_scroll1)">
            <path fillRule="evenodd" clipRule="evenodd" d="M13 22C14.5524 22.0001 16.0444 21.3984 17.1625 20.3215C18.2806 19.2446 18.9378 17.7763 18.996 16.225L19 16V8C19.0001 6.44762 18.3984 4.95564 17.3215 3.83753C16.2446 2.71942 14.7763 2.06221 13.225 2.004L13 2H11C9.44762 1.99994 7.95564 2.60157 6.83753 3.67846C5.71942 4.75536 5.06221 6.22371 5.004 7.775L5 8V16C4.99994 17.5524 5.60157 19.0444 6.67847 20.1625C7.75536 21.2806 9.22371 21.9378 10.775 21.996L11 22H13ZM12 18C11.7348 18 11.4804 17.8946 11.2929 17.7071C11.1054 17.5196 11 17.2652 11 17V13C11 12.7348 11.1054 12.4804 11.2929 12.2929C11.4804 12.1054 11.7348 12 12 12C12.2652 12 12.5196 12.1054 12.7071 12.2929C12.8946 12.4804 13 12.7348 13 13V17C13 17.2652 12.8946 17.5196 12.7071 17.7071C12.5196 17.8946 12.2652 18 12 18Z" className="fill-custom-dark-blue-gray"/> {/* fill="#373552" */}
          </g>
          <defs><clipPath id="clip0_1_980_hero_scroll1"><rect width="24" height="24" fill="white" transform="matrix(1 0 0 -1 0 24)"/></clipPath></defs>
        </svg>
        <div className="self-stretch text-center text-gray-700 text-xs font-normal">Défiler</div> {/* Changed to text-center */}
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_1_985_hero_scroll2)">
            <path fillRule="evenodd" clipRule="evenodd" d="M13.06 16.06C12.7788 16.3409 12.3975 16.4987 12 16.4987C11.6025 16.4987 11.2213 16.3409 10.94 16.06L5.28202 10.404C5.00076 10.1226 4.8428 9.74102 4.8429 9.34316C4.84299 8.9453 5.00113 8.56377 5.28252 8.28251C5.56392 8.00125 5.94552 7.84329 6.34338 7.84338C6.74123 7.84348 7.12276 8.00162 7.40402 8.28301L12 12.879L16.596 8.28301C16.8788 8.00964 17.2576 7.85827 17.6509 7.8615C18.0442 7.86473 18.4205 8.0223 18.6988 8.30028C18.977 8.57827 19.1349 8.95441 19.1385 9.34771C19.1421 9.741 18.9911 10.12 18.718 10.403L13.061 16.061L13.06 16.06Z" className="fill-custom-dark-blue-gray"/> {/* fill="#373552" */}
          </g>
          <defs><clipPath id="clip0_1_985_hero_scroll2"><rect width="24" height="24" fill="white"/></clipPath></defs>
        </svg>
      </div>

      {/* Contact Form */}
      <div className="w-[520px] h-[580px] left-[929px] top-[12px] absolute sha">
        <div className="w-full h-full bg-white rounded-[20px] shadow-amber-50 p-[26px]"> {/* Added p-[26px] instead of absolute child */}
          <div className="flex flex-col justify-start items-start gap-14 h-full">
            <div className="self-stretch flex flex-col justify-start items-start gap-12">
              ...
              <div className="self-stretch flex flex-col justify-start items-start gap-12">
                <form
                  className="self-stretch flex flex-col justify-start items-start gap-12 w-full"
                  onSubmit={async (e) => {
                    e.preventDefault();
                ...
                >
                 ...
                 <button
  type="submit"
  className="self-stretch h-14 px-44 py-4 rounded-xl inline-flex justify-center items-center gap-2.5 text-white text-base font-bold bg-[#6863BF] hover:opacity-90 transition-opacity"
>
  Prendre RDV
</button>
      ...
      <div className="fixed right-0 top-1/3 z-40 w-14 h-72 px-4 py-6 bg-gray-800 rounded-tl-xl rounded-bl-xl flex flex-col justify-center items-center gap-7">
